          ...
          <CSSTransition component="div" classNames="TabsAnimation" appear={true}
            ...
            <div>
              <div className={cx("app-inner-layout chat-layout", {
                ...
                <div className="text-white app-inner-layout__header bg-premium-dark">
                ...
                <div className="app-inner-layout__wrapper">
                  <Card className="app-inner-layout__content">
                    <div className="table-responsive">
                      <div className="app-inner-layout__top-pane">
                        <div className="pane-left">
                          ...
                          <div className="avatar-icon-wrapper me-2">
                            ...
                            <div className="rounded avatar-icon avatar-icon-xl">
                              <Image width={82} src={avatar2} alt="" />
                            </div>
                          </div>
                        ...
                        <div className="chat-box-wrapper">
                          <div>
                            <div className="avatar-icon-wrapper me-1">
                              <div className="badge badge-bottom btn-shine bg-success badge-dot badge-dot-lg" />
                              <div className="rounded avatar-icon avatar-icon-lg">
                      ...
                      <div className="text-center app-inner-layout__bottom-pane d-block">
                  ...
                  <Card className="app-inner-layout__sidebar">
                    <div className="app-inner-layout__sidebar-header">
                      <Nav vertical>
                        <NavItem className="pt-4 pb-3 ps-3 pe-3">
                          <InputGroup>
                    ...
                    <div className="pb-3 app-inner-layout__sidebar-footer">
                      <Nav vertical>
                        <NavItem className="nav-item-divider" />
                        <NavItem className="nav-item-header">
                          Offline Friends
                        </NavItem>
                        <NavItem className="p-2 text-center">
                          <div className="avatar-wrapper avatar-wrapper-overlap">
                            <div className="avatar-icon-wrapper">
                              <div className="badge badge-bottom bg-danger badge-dot badge-dot-lg" />
                              <div className="rounded avatar-icon">
                                <img src={avatar1} alt="" />
                              </div>
                            </div>
                            <div className="avatar-icon-wrapper">
